<!-- Modal -->
<div class="modal fade" id="exportPembelian" data-bs-backdrop="static" tabindex="-1" aria-labelledby="exportModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="function/pembelian-export.php" method="post" enctype="multipart/form-data" id="oksubmit">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-round btn-info color-theme" href="function/pembelian-export-all.php">Export all</a>
        </div>
      </form>
