    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="./menu-user.php">
          <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-user-alt text-secondary text-sm opacity-10"></i>
          </div>
          <span class="nav-link-text ms-1">Daftar User</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="./menu-pembelian.php">
          <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-box text-secondary text-sm opacity-10"></i>
          </div>
          <span class="nav-link-text ms-1">Daftar Pembelian</span>
        </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link " href="./menu-retur.php">
          <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-cart-arrow-down text-secondary text-sm opacity-10"></i>
          </div>
          <span class="nav-link-text ms-1">Daftar Retur</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="./menu-sku.php">
          <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa fa-ticket text-secondary text-sm opacity-10"></i>
          </div>
          <span class="nav-link-text ms-1">Daftar SKU</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="./menu-toko.php">
          <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa fa-solid fa-store text-secondary text-sm opacity-10"></i>  
          </div>
